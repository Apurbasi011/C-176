...
label_download = Label(root, text = "Download Speed", font = ("Segoe Print", 18, "bold"), fg = "#1E8449", 
                       bg = "#dee8f1")
label_download.place(relx = 0.25, rely = 0.5, anchor = CENTER)

label_upload = Label(root, text = "Upload Speed", font = ("Segoe Print", 18, "bold"), fg = "#9B59B6", 
                     bg = "#dee8f1" )
